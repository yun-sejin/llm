...
def upsert_all_data():
   ...
   # Assuming you have already established a database connection and created a cursor named 'cur'
    ...
    for row in rows:
        ...
        # Assuming 'base_dir2' is defined and points to the base directory where the files are located
        file_list = row[1]  # This assumes 'file_list' is stored in a format that Python can directly use as a list
        all_data = []
        ...
        print(all_data)        
        # Process 'all_data' as needed, similar to the provided code snippet
